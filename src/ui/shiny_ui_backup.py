    ...
    ui.layout_sidebar(
        ...
        ui.panel_main(
            ui.navset_card_underline(
                ui.nav_panel("Chat History", ui.output_text("chat_history_render")),
        ...
        if user_message:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    chat_history_output.set(output_text)
                else:
                    #chat_history.append((user_message, f"Error: {response.status_code} - {response.text}"))
                    pass
            except Exception as e:
                #chat_history.append((user_message, f"Error: Failed to communicate with the API - {str(e)}"))
                pass 
