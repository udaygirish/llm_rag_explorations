...
class ChatBot:
    ...
    def respond(chatbot: List, message: str, chat_type: str, app_functionality: str) -> Tuple:
        ...
        """
        print("APP Functionality: ", app_functionality)
        if app_functionality == "Chat" or app_functionality=="LocalChat":
            if app_functionality=="LocalChat":
                # APPCFG.load_local_model_bool = True
                # On Default runs with OLLAMA
                APPCFG = LoadConfig(llm_local_bool=True)
            else:
                APPCFG = LoadConfig()
            ...
            if chat_type == "Q&A with stored SQL-DB":
                ...
                if os.path.exists(APPCFG.sqldb_directory):
                    ...
                    return "", chatbot, None
            elif chat_type == "Generic" or chat_type == "Generic Q&A":
                # FIll Generic Q&A
                ...
                response = APPCFG.langchain_llm.invoke(prompt_message)
