...
class LoadConfig:
    def __init__(self, llm_local_bool=False) -> None:
        with open(here("configs/app_config.yml")) as cfg:
            app_config = yaml.load(cfg, Loader=yaml.FullLoader)
        self.load_local_model_bool=llm_local_bool
    ...
    def load_openai_models(self):
        ...
        # ToDO: Convert LLAMA Model Embedding or any Open Source Embedding
        # Addition - Through Hugging Face and Ollama
        if self.load_local_model_bool == False:
